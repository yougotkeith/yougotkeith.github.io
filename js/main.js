...
// Added this block from CodyHouse comments to make menu auto close after use (http://codyhouse.co/gem/smart-fixed-navigation/#comment-2101111888)
	$("#cd-main-nav ul li a").click(function () {
	$("#cd-main-nav ul").removeClass('is-visible');
	$(".cd-nav-trigger").removeClass('menu-is-open');
	});
// End: block from CodyHouse comments
